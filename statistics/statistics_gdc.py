...
# Load the CSV file
data = pd.read_csv('../data/gdc_oral_cancer_dataset/labels.csv')  # Replace with actual file path

# Create a PDF file to save all plots
pdf_filename = "statistics_gdc.pdf"
# 'Age' ,'Gender,Cigarette/Bidi,Smokeless tobacco,Areca nut,Alcohol,Able to open mouth,Lesion/patch,Provisional diagnosis,Risk,Specialist diagnosis,Specialist recommendation,Specialist notes
# Category,Clinical Diagnosis,Lesion Annotation Count
with PdfPages(pdf_filename) as pdf:
    # Categorical columns for pie charts
    categorical_columns =[
    "Gender", "Cigarette/Bidi", "Smokeless tobacco", "Areca nut", "Alcohol",
    "Able to open mouth", "Lesion/patch", "Provisional diagnosis", "Risk",
    "Specialist diagnosis", "Specialist recommendation", 
]
